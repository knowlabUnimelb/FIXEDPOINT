...
set(gca, 'XLim', xlims, 'YLim', ylims, 'FontSize', 14)
xlabel('t (msec)', 'FontSize', 14)
ylabel('SIC_{OR}(t)', 'FontSize', 14)
title('OR Task Parallel ST/Coactive', 'FontSize', 20)
...
xlabel('t (msec)', 'FontSize', 14)
ylabel('SIC_{OR}(t)', 'FontSize', 14)
title('OR Task Parallel ST/Serial ST', 'FontSize', 20)
% legend(num2str((0:.2:1)'))
for i = 1:size(colors, 1)
    set(h(i), 'Color', colors(i,:), 'LineWidth', 2)
end
...
set(gca, 'XLim', xlims, 'YLim', ylims, 'FontSize', 14)
xlabel('t (msec)', 'FontSize', 14)
ylabel('SIC_{AND}(t)', 'FontSize', 14)
title('AND Task Parallel EX/Coactive', 'FontSize', 20)
% legend(num2str((0:.2:1)'))
for i = 1:size(colors, 1)
    set(h(i), 'Color', colors(i,:), 'LineWidth', 2)
end
...
set(gca, 'XLim', [0 2000], 'YLim', [-1 .5], 'FontSize', 14)
xlabel('t (msec)', 'FontSize', 14)
ylabel('SIC_{AND}(t)', 'FontSize', 14)
title('AND Task Parallel EX/Serial EX', 'FontSize', 20)
% legend(num2str((0:.2:1)'))
for i = 1:size(colors, 1)
    set(h(i), 'Color', colors(i,:), 'LineWidth', 2)
end
